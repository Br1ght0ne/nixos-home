...
**** Checkbox -> TODO
#+BEGIN_SRC emacs-lisp
;; Last revision: 2019-12-10 09:27
;; commit 2441b447897e561a29d263e204e5700bf5f920d9
(el-patch-defun +org-init-capture-defaults-h ()
...
2. Through a org-capture popup frame that is invoked from outside Emacs (the
  ...
  (setq org-default-notes-file
        ...
        '(("t" "Personal todo" entry
           ...
           ;; HACK: use `TODO' instead of `[ ]'
           (el-patch-concat "* " (el-patch-swap "[ ]" "TODO") " %?\n%i\n%a") :prepend t)
